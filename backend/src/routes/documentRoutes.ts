...
import { uploadDocument, getStudentDocuments, getAllDocuments, generateReport, downloadDocument, previewDocument, deleteDocument, getDocumentData } from '../controllers/documentController.js';
...
router.get('/data/:id', authenticate, getDocumentData);
